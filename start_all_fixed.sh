...
# Korean Chick - Запуск бота и Web App одновременно (ИСПРАВЛЕННАЯ ВЕРСИЯ)
...
echo ""
echo "🔧 ДЛЯ PRODUCTION НА testdlyavsego.ru:"
echo "   1. Собери frontend: cd web-app/frontend && npm run build"
echo "   2. Загрузи содержимое папки dist на testdlyavsego.ru"
echo "   3. Настрой backend на сервере с проксированием /api на порт 8000"
echo "   4. Убедись что .env файлы настроены правильно"
echo ""
echo "⚠️  ВАЖНО: Mini app в Telegram будет работать только после деплоя на testdlyavsego.ru!"
echo "   Локально можно тестировать только через браузер на localhost:3000"
echo ""
